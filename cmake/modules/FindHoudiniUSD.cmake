...
find_path(Houdini_Python_INCLUDE_DIR
	...
	PATH_SUFFIXES
		...
		"toolkit/include/python3.11" # Houdini 20.5
	NO_DEFAULT_PATH)
...
find_file(
	...
	NAMES
		...
		"libpython3.11${CMAKE_SHARED_LIBRARY_SUFFIX}" # Unix, Houdini 20.5
...
find_file(
	...
	"libhboost_python311${CMAKE_SHARED_LIBRARY_SUFFIX}" # Unix, Houdini 20.5
	...
	"hboost_python311-mt-x64.lib" # Windows (import lib), Houdini 20.5
	PATHS ENV HFS
	PATH_SUFFIXES
		"dsolib" # Linux
		"../Libraries" # macOS
